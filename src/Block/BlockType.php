...
enum BlockType
{
    ...
    public function getBlockDataClass(): string
    {
        return match ($this) {
            ...
            self::ANVIL => throw new \Exception('To be implemented'),
            ...
            self::CHEST => throw new \Exception('To be implemented'),
            ...
            self::COBBLESTONE => throw new \Exception('To be implemented'),
            ...
            self::CORNFLOWER => throw new \Exception('To be implemented'),
            ...
            self::DANDELION => throw new \Exception('To be implemented'),
            ...
            self::DIRT => throw new \Exception('To be implemented'),
            self::DIRT_PATH => throw new \Exception('To be implemented'),
            ...
            self::FLETCHING_TABLE => throw new \Exception('To be implemented'),
            ...
            self::GLASS_PANE => throw new \Exception('To be implemented'),
            ...
            self::GRASS_BLOCK => throw new \Exception('To be implemented'),
            ...
            self::MOSSY_COBBLESTONE => throw new \Exception('To be implemented'),
            ...
            self::OAK_DOOR => throw new \Exception('To be implemented'),
            ...
            self::OAK_LOG => throw new \Exception('To be implemented'),
            self::OAK_PLANKS => throw new \Exception('To be implemented'),
            self::OAK_PRESSURE_PLATE => throw new \Exception('To be implemented'),
            self::OAK_SAPLING => throw new \Exception('To be implemented'),
            self::OAK_SIGN => throw new \Exception('To be implemented'),
            self::OAK_SLAB => throw new \Exception('To be implemented'),
            self::OAK_STAIRS => throw new \Exception('To be implemented'),
            ...
            self::OXEYE_DAISY => throw new \Exception('To be implemented'),
            ...
            self::POPPY => throw new \Exception('To be implemented'),
            ...
            self::POTTED_DANDELION => throw new \Exception('To be implemented'),
            ...
            self::SHORT_GRASS => throw new \Exception('To be implemented'),
            ...
            self::STRIPPED_OAK_LOG => throw new \Exception('To be implemented'),
            self::STRIPPED_OAK_WOOD => throw new \Exception('To be implemented'),
            ...
            self::TALL_GRASS => throw new \Exception('To be implemented'),
            ...
            self::WALL_TORCH => throw new \Exception('To be implemented'),
            ...
            self::WHITE_BED => throw new \Exception('To be implemented'),
            ...
            self::WHITE_WOOL => throw new \Exception('To be implemented'),
            ...
            self::YELLOW_CARPET => throw new \Exception('To be implemented'),
            ...
            self::YELLOW_WOOL => throw new \Exception('To be implemented'),
