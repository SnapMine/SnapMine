...
use Nirbose\PhpMcServ\Block\Type\ExposedCopperBulb;
...
use Nirbose\PhpMcServ\Block\Type\HasRecordBlockData;
...
use Nirbose\PhpMcServ\Block\Type\MoistureBlockData;
...
use Nirbose\PhpMcServ\Block\Type\OxidizedCopperBulb;
...
use Nirbose\PhpMcServ\Block\Type\PressurePlate;
...
use Nirbose\PhpMcServ\Block\Type\WaxedCopperBulb;
use Nirbose\PhpMcServ\Block\Type\WaxedExposedCopperBulb;
use Nirbose\PhpMcServ\Block\Type\WaxedOxidizedCopperBulb;
use Nirbose\PhpMcServ\Block\Type\WaxedWeatheredCopperBulb;
use Nirbose\PhpMcServ\Block\Type\WeatheredCopperBulb;
...
enum BlockType
{
    ...
    public function getBlockDataClass(): string
    {
        return match ($this) {
            ...
            self::ACACIA_FENCE, self::ACACIA_FENCE_GATE, self::BAMBOO_FENCE, self::BAMBOO_FENCE_GATE, self::BIRCH_FENCE, self::BIRCH_FENCE_GATE, self::CHERRY_FENCE, self::CHERRY_FENCE_GATE, self::CRIMSON_FENCE, self::CRIMSON_FENCE_GATE, self::DARK_OAK_FENCE, self::DARK_OAK_FENCE_GATE, self::JUNGLE_FENCE, self::JUNGLE_FENCE_GATE, self::MANGROVE_FENCE, self::MANGROVE_FENCE_GATE, self::NETHER_BRICK_FENCE, self::OAK_FENCE, self::OAK_FENCE_GATE, self::PALE_OAK_FENCE, self::PALE_OAK_FENCE_GATE, self::SPRUCE_FENCE, self::SPRUCE_FENCE_GATE, self::WARPED_FENCE, self::WARPED_FENCE_GATE => Fence::class,
            ...
            self::ACACIA_PRESSURE_PLATE, self::BAMBOO_PRESSURE_PLATE, self::BIRCH_PRESSURE_PLATE, self::CHERRY_PRESSURE_PLATE, self::CRIMSON_PRESSURE_PLATE, self::DARK_OAK_PRESSURE_PLATE, self::HEAVY_WEIGHTED_PRESSURE_PLATE, self::JUNGLE_PRESSURE_PLATE, self::LIGHT_WEIGHTED_PRESSURE_PLATE, self::MANGROVE_PRESSURE_PLATE, self::OAK_PRESSURE_PLATE, self::PALE_OAK_PRESSURE_PLATE, self::POLISHED_BLACKSTONE_PRESSURE_PLATE, self::SPRUCE_PRESSURE_PLATE, self::STONE_PRESSURE_PLATE, self::WARPED_PRESSURE_PLATE => PressurePlate::class,
            ...
            self::COPPER_BULB => CopperBulb::class,
            ...
            self::END_GATEWAY => Gate::class,
            self::END_PORTAL_FRAME => EndPortalFrame::class,
            self::EXPOSED_COPPER_BULB => ExposedCopperBulb::class,
            self::FARMLAND => MoistureBlockData::class,
            ...
            self::JUKEBOX => HasRecordBlockData::class,
            ...
            self::OXIDIZED_COPPER_BULB => OxidizedCopperBulb::class,
            ...
            self::TARGET => PowerBlockData::class,
            self::TNT => Tnt::class,
            ...
            self::WAXED_COPPER_BULB => WaxedCopperBulb::class,
            self::WAXED_EXPOSED_COPPER_BULB => WaxedExposedCopperBulb::class,
            self::WAXED_OXIDIZED_COPPER_BULB => WaxedOxidizedCopperBulb::class,
            self::WAXED_WEATHERED_COPPER_BULB => WaxedWeatheredCopperBulb::class,
            self::WEATHERED_COPPER_BULB => WeatheredCopperBulb::class,
